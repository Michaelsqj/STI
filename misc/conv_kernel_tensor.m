...
% calculate the convolutional kernel of STI in k-space
% INPUT:
% 
% Params:   data parameter structure
%           should have Params.sizeVol, Params.fov, Params.TAng
%
% OUTPUT:   [a11, a12, a13, a22, a23, a33]
%           kernel that can be multiplied to tensor components in k-space without fftshift
%           e.g. chi11k = fftn(chi11); ... and
